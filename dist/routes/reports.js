...
const reports = new hono_1.Hono();
reports.get("/excel", auth_1.authMiddleware, async (c) => {
    ...
    */
    ...
    =============================
    */
    const metrics = await client_1.pool.query(`SELECT
    ...
    =============================
    */
    const feedbacks = await client_1.pool.query(`SELECT
      c.name,
      f.atendimento,
      f.qualidade_comida,
      f.tempo_espera,
    ...
    =============================
    */
    const ranking = await client_1.pool.query(`SELECT
      a.id,
      a.name,
     ...
     ORDER BY media_rating DESC`, params);
    ...
    =============================
    */
    const attendantFeedbacks = await client_1.pool.query(`SELECT
      a.name AS attendant,
      c.name AS customer,
      ar.rating,
      ar.comment,
     ...
     WHERE f.restaurant_id = $1
     ${dateFilter}
     ORDER BY a.name, f.created_at DESC`, params);
    ...
    */
    ...
    c.header("Content-Disposition", "attachment; filename=relatorio-feedbacks.xlsx");
